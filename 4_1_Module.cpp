...
void updateLEDs(){
	...
	led2 = 0;
	led3 = 0;
	//whichever LED has the most count is turned on
...
void button_4_handler(){
	// Turn off all LEDs and set counters to 0.
	led1 = 0;
	led2 = 0;
	led3 = 0;
...
int main(){
	...
	//Interrupt handlers
	//set buttons to their corresponding intterupt handlers? so set btn1 = hander 1 which means
	//it runs the handler 1 function?
